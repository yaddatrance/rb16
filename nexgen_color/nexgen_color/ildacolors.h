#ifndef _ILDACOLORS_H_
#define _ILDACOLORS_H_

const unsigned char ilda_standard_color_palette[256][3]={
    {   255,     0,   0 }, // #0	
    {   255,    16,   0 },	
    {   255,    32,   0 },	
    {   255,    48,   0 },	
...
const unsigned char ilda_bildaoff_color_palette[256][3]={
...
const unsigned char ilda_laserill_color_palette[256][3]={
    {   0,   0,   0 },	// Black/blanked (fixed)
    { 255, 255, 255 },	// White (fixed)
    { 255,   0,   0 },  // Red (fixed)
    {   0, 255,   0 },  // Green (fixed)
...
const unsigned char ilda_x29_color_palette[256][3]={
    {   0,   0,   0 },	// Black/blanked (fixed) 0
    {   0,   0,   0 },	// Black/blanked (fixed) 1
    { 255,   0,   0 },  // Red (fixed) 2
    { 255,   0,   0 },  // Red (fixed) 3
    { 255, 255,   0 },  // Yellow (fixed) 4
    { 255, 255,   0 },  // Yellow (fixed) 5
    {   0, 255,   0 },  // Green (fixed) 6
    {   0, 255,   0 },  // Green (fixed) 7
    { 128, 128,   0 },  // 8
    { 128, 128,   0 },  // 9
    {   0,   0, 255 },  // Blue (fixed) 10
    {   0,   0, 255 },  // Blue (fixed) 11
    { 255,   0, 255 },  // Magenta (fixed) 12
    { 255,   0, 255 },  // Magenta (fixed) 13
    { 255, 255, 255 },  // 14
    { 255, 255, 255 },  // 15
    {   0, 255, 255 },  // Cyan (fixed) 16
    {   0, 255, 255 },  // Cyan (fixed) 17
    {   0, 255, 255 },  // Cyan (fixed) 18
    {   0, 255, 255 },  // Cyan (fixed) 19
    { 255,   0,   0 },  // Red (fixed) 20
    { 255,   0,   0 },  // Red (fixed) 
    { 255,   0,   0 },  // Red (fixed) 
    { 255,   0,   0 },  // Red (fixed) 
    { 255,   0,   0 },  // Red (fixed) 
